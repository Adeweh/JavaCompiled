...
public PetrolPurchase(String stationLocation, String petrolType, double pricePerLitre, double percentageDiscount,int quantityPurchase) {                           
    ...
    {
        double netPurchaseAmount = pricePerLitre * quantityPurchase;
        
        double purchaseAmount = netPurchaseAmount - percentageDiscount;
